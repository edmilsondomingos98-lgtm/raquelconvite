...
export default function StepWizard() {
  ...
  return (
    <main className="relative min-h-[100dvh] bg-dusk flex flex-col items-center justify-center px-5 py-10 overflow-hidden">
      ...
      <HibiscusBloom className="absolute -top-3 -left-3 w-16 h-16 sm:-top-6 sm:-left-8 sm:w-40 sm:h-40 opacity-90 drop-shadow-lg" />
      <HibiscusBloom className="absolute -top-4 -right-4 w-20 h-20 sm:-top-10 sm:-right-10 sm:w-48 sm:h-48 opacity-90 drop-shadow-lg rotate-12" />
      <PalmFrond className="absolute bottom-0 -left-1 w-14 sm:-left-4 sm:w-36 opacity-80" />
      <PalmFrond className="absolute bottom-0 -right-1 w-14 sm:-right-4 sm:w-36 opacity-80 -scale-x-100" />
