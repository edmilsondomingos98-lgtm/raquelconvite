    ...
    return (
      <div className="flex flex-col items-center text-center gap-3">
        ...
        <p className="text-ink/70 max-w-[32ch] leading-relaxed">
          Obrigada por confirmares, {nome.split(" ")[0]}. Um encarregado da{" "}
          {PARTY.nome} pode entrar em contacto pelo número que deixaste para
          combinar os detalhes. Até {PARTY.diaSemana.toLowerCase()}! 🌺
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col items-center text-center gap-4 w-full">
      ...
      <p className="text-ink/70 max-w-[32ch] leading-relaxed -mt-1">
        Como é uma festa de crianças, pedimos o nome e o contacto do
        encarregado — assim os adultos combinam tudo entre si.
      </p>
